...
namespace EliteFifa\TeamBundle\DataFixtures\ORM\Team;
...
class TeamFixtures extends AbstractFixture implements DependentFixtureInterface, ContainerAwareInterface
{
    ...
    {
        return [
            'EliteFifa\StadiumBundle\DataFixtures\ORM\Stadium\StadiumFixtures',
            'EliteFifa\UserBundle\DataFixtures\ORM\User\UserFixtures'
        ];
    }
}