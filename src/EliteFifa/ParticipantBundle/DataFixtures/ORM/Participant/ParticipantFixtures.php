...
namespace EliteFifa\ParticipantBundle\DataFixtures\ORM\Participant;
...
class ParticipantFixtures extends AbstractFixture implements DependentFixtureInterface, ContainerAwareInterface
{
    ...
    {
        return [
            'EliteFifa\TeamBundle\DataFixtures\ORM\Team\TeamFixtures',
            'EliteFifa\SeasonBundle\DataFixtures\ORM\Season\SeasonFixtures',
            'EliteFifa\CompetitionBundle\DataFixtures\ORM\Competition\CompetitionFixtures'
        ];
    }
}